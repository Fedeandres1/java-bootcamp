...
public class Hello extends javax.swing.JFrame {
    ...
    public Hello() {
        initComponents();
        Libro l=new Libro();
        this.txt_area.setText(l.toString());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Hello World! I am using Maven!");
...
JOptionPane.showMessageDialog(this, this.txt_nombre.getText());        // TODO add your handling code here:
