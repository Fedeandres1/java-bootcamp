...
import Gestor.GestorShoppingCart;
...
public class Probar extends javax.swing.JFrame {
    ...
    public Probar() {
        initComponents();
        GestorShoppingCart cart=new GestorShoppingCart();
       this.txt_mostrar.setText( cart.crearPedido().toString());
       this.txt_mostrar.append(cart.createOffer().toString());
